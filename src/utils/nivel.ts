...
export function nivelDeScore(scoreRaw: number | null | undefined): NivelInfo {
  ...
  if (score >= 0.8) {
    return {
      nombre: 'EXCELENTE', color: 'success', hex: '#1f9d57',
      progreso: 100, siguiente: null, faltaParaSiguiente: null,
    };
  }
  if (score >= 0.6) {
    return {
      nombre: 'BUENO', color: 'primary', hex: '#534AB7',
